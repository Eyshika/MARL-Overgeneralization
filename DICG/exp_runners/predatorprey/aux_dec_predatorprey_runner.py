...
from envs import CoopPredatorPreyWrapper
from dicg.torch.baselines import GaussianMLPBaseline
# from dicg.torch.algos import CentralizedMAPPO
from dicg.torch.algos import CentralizedMAPPOWithAuxLoss
from dicg.torch.policies import CoopDecCategoricalMLPPolicy
from dicg.experiment.local_runner_wrapper import LocalRunnerWrapper
from dicg.sampler import CoopCentralizedMAOnPolicyVectorizedSampler
...
def run(args):
    ...
    if args.mode == 'train':
        ...
        def train_predatorprey(ctxt=None, args_dict=vars(args)):
            ...
            policy = CoopDecCategoricalMLPPolicy(
                env.spec,
                env.n_agents,
            ...
            algo = CentralizedMAPPOWithAuxLoss(
                env_spec=env.spec,
                policy=policy,
                baseline=baseline,
            ...
            runner.setup(algo, env,
                sampler_cls=CoopCentralizedMAOnPolicyVectorizedSampler, 
